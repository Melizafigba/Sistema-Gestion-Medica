...
public class ModificarHijos extends javax.swing.JFrame {

    Conexion cone;
    DefaultTableModel modelo;
    Conexion funcion = new Conexion();

    public ModificarHijos() {
        cone = new Conexion();
        initComponents();
        consulta("");
    ...
    public void consulta(String buscar1) {
        ...
        try {
            ...
            String[] titulos = {"ID", "NOMBRE","APELLIDO", "RUT", "RUT TUTOR"};
            modelo = new DefaultTableModel(null, titulos);
            ResultSet rs = cone.consultabd("SELECT * FROM hijos WHERE CONCAT (id,nombre,apellido,rut,padre_id) LIKE '%" + buscar1 + "%' ");
            String[] datos = new String[10];
            while (rs.next()) {
                datos[0] = rs.getString("id");
                datos[1] = rs.getString("nombre");
                datos[2] = rs.getString("apellido");
                datos[3] = rs.getString("rut");
                datos[4] = rs.getString("padre_id");
            ...
            Logger.getLogger(ModificarHijos.class.getName()).log(Level.SEVERE, null, ex);
        }
        limpiar();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Modifica Datos del Infante");
        ...
        AtencionMedica.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        AtencionMedica.setForeground(new java.awt.Color(255, 255, 255));
        AtencionMedica.setText("  Atencion Médica  ");
        AtencionMedica.setFont(new java.awt.Font("Dubai", 0, 18)); // NOI18N
    ...
    private void jeliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jeliminarActionPerformed
        cone.modificabd("DELETE FROM hijos WHERE rut = " + modelo.getValueAt(iDatos1.getSelectedRow(), 3));
        consulta("");
    ...
    private void AtencionMedicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AtencionMedicaMouseClicked
        AtencionMedica Atmed = new AtencionMedica();
        Atmed.setVisible(true);
        this.setVisible(false);
