...
public class Asistentes extends javax.swing.JInternalFrame {
Conexion cone;
    public Asistentes() {
        cone = new Conexion();
        initComponents();
    ...
    private void initComponents() {
        ...
        CuadroEmail.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CuadroEmail1ActionPerformed(evt);
            }
        });
        ...
        CuadroPassword.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CuadroPassword1ActionPerformed(evt);
            }
        });
        ...
        jPanel1.add(Login, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 470, 130, 50));
        ...
        jPanel1.add(FondoLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 470, 130, 60));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 420, 490, 20));
        ...
        ImgMedicine.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Asistente.png"))); // NOI18N
        jPanel2.add(ImgMedicine, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, -1, -1));
        ...
        jPanel2.add(LineMedicos, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 100, 20));
    ...
    try {
        ResultSet rs = cone.consultabd("SELECT * FROM inicio_asistente WHERE usuario = "
                + "'"+CuadroEmail.getText()+"' AND contraseña = '"+CuadroPassword.getText()+"'");
        if (rs.next()){
            AsistentePage2 AsPage2 = new AsistentePage2();
            AsPage2.setVisible(true);
            AsPage2.setSize(1280, 700);
            dispose();
    ...
    private void CuadroEmail1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CuadroEmail1ActionPerformed
        
    }//GEN-LAST:event_CuadroEmail1ActionPerformed
    ...
    private void CuadroPassword1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CuadroPassword1ActionPerformed
        validar();
    }//GEN-LAST:event_CuadroPassword1ActionPerformed
