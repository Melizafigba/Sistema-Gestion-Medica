...
public void validar(){
    ...
    try {
        ...
        if (rs.next()){
            RegistroDoc in = new RegistroDoc();
            in.setVisible(true);
            in.setSize(1280, 700);
        }else{
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, 490, 20));
        ...
        ImgMedicine.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Administrador.png"))); // NOI18N
        jPanel2.add(ImgMedicine, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 130, 620, -1));
        ...
        jPanel2.add(LineMedicos, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, 120, 20));
