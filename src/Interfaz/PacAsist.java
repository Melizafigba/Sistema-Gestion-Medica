...
public class PacAsist extends javax.swing.JFrame {

    Conexion cone;
    DefaultTableModel modelo;

    public PacAsist(String nombre) {
        cone = new Conexion();
        initComponents();
    ...
    public void consulta(String buscar) {
        ...
        try {
            ...
            String[] titulos = {"Nombre", "Apellido", "Cedula", "Celular", "Correo", "Fecha_cita", "Horario", "Jornada", "Tipo_cita_id", "Sexo"};
